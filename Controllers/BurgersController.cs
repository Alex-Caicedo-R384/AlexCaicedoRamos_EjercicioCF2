...
namespace AlexCaicedoRamos_EjercicioCF2.Controllers
{
    public class BurgersController : Controller
    {
        private readonly AlexCaicedoRamos_EjercicioCF2Context _context;

        public BurgersController(AlexCaicedoRamos_EjercicioCF2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'AlexCaicedoRamos_EjercicioCF2Context.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AlexCaicedoRamos_EjercicioCF2Context.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
