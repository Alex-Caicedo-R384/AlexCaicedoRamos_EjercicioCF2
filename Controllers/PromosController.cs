...
namespace AlexCaicedoRamos_EjercicioCF2.Controllers
{
    public class PromosController : Controller
    {
        ...
        public PromosController(AlexCaicedoRamos_EjercicioCF2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Promo != null ? 
                          ...
                          Problem("Entity set 'AlexCaicedoRamos_EjercicioCF2Context.Promo'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AlexCaicedoRamos_EjercicioCF2Context.Promo'  is null.");
            }
            var promo = await _context.Promo.FindAsync(id);
            if (promo != null)
            {
